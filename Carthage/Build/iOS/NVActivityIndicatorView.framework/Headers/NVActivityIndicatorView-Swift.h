...
/// Create a activity indicator view with default type, color and padding. This is used by storyboard to initiate the view.
///
/// <ul><li>Default type is BallSpinFadeLoader.</li><li>Default color is white.</li><li>Default padding is 0.</li></ul>
/// \param decoder 
///
